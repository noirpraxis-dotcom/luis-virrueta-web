...
const blogArticlesContent = {
  ...
  'fabrica-percepciones-identidades-imaginadas': {
    ...
    sections: [
      {
        type: 'intro',
        content: 'Iba por la carretera observando a unos trabajadores diminutos frente al paisaje inmenso que los contenía. Sentí una punzada de envidia: ellos pertenecían a ese mundo; yo solo lo miraba desde la distancia. Pero de pronto comprendí algo inquietante: ellos no estaban viviendo la escena que yo estaba viendo.'
      },
      {
        type: 'heading',
        title: 'CAPÍTULO I — El deseo de habitar la imagen',
        icon: Eye
      },
      {
        type: 'text',
        content: 'Su mirada no estaba en la magnificencia del horizonte, sino en la urgencia del trabajo. Yo estaba en el asiento pasivo del coche; ellos estaban en el peso activo de la realidad. Ellos no pertenecían al paisaje como belleza… pertenecían a la tarea.'
      },
      {
        type: 'text',
        content: 'Ahí recordé a Sartre cuando afirmaba que "El infierno son los otros", pero quizá también lo contrario: el paraíso son los otros, cuando no estamos obligados a vivir su peso. Desde lejos, romantizamos. Desde fuera, idealizamos. Desde la contemplación, tejemos ficciones.'
      },
      {
        type: 'highlight',
        content: 'Lacan diría que lo que deseaba no era la escena, sino la mirada del Otro inscrita en ella. No envidiaba su realidad; envidiaba la narrativa que mi mente construía sobre ella.',
        author: 'Luis Virrueta'
      },
      {
        type: 'text',
        content: 'Freud lo habría dicho de otra forma: "Donde estaba la cosa, debe advenir el sujeto". Pero cuando miro al otro, no dejo que advenga su verdad: proyecto la mía.'
      },
      {
        type: 'text',
        content: 'Walter Benjamin escribió que toda experiencia moderna está mediada por imágenes. Yo no vi trabajadores. Vi una postal existencial, un cuadro romántico donde yo quería entrar porque no lo estaba viviendo.'
      },
      {
        type: 'highlight',
        content: 'Y entonces algo se quiebra: Lo que miro no es el mundo. Es mi deseo disfrazado de paisaje.',
        author: 'Luis Virrueta'
      },
      {
        type: 'list',
        title: '❓ Preguntas psicoanalíticas',
        items: [
          {
            title: '¿Deseas realmente lo que miras?',
            description: '¿O deseas la emoción que tu fantasía construye sobre ello?'
          },
          {
            title: '¿Has confundido alguna vez belleza con distancia emocional?',
            description: 'La belleza aparece cuando no estamos obligados a cargar con el peso de lo real.'
          },
          {
            title: '¿Cuántas veces tu envidia es simplemente nostalgia?',
            description: 'Nostalgia de algo que nunca has vivido… y que quizá, vivido, no soportarías.'
          }
        ]
      },
      {
        type: 'heading',
        title: 'CAPÍTULO II — La ficción del "vivir en primera persona"',
        icon: Brain
      },
      {
        type: 'text',
        content: 'Pensé en las series como Élite, donde parece maravilloso pertenecer a un grupo de amigos intensos, caóticos, fascinantes. Pero entonces surge la pregunta brutal: ¿Realmente sería disfrutable vivir lo que maravillamos al mirar?'
      },
      {
        type: 'text',
        content: 'Nietzsche advertía que la vida trágica vista desde la distancia parece sublime, pero vivida desde dentro quiebra huesos. Kierkegaard decía que la existencia estética fascina mientras no compromete la piel. Lo espectacular, visto desde fuera, es adrenalina estética; desde dentro, es angustia ontológica.'
      },
      {
        type: 'highlight',
        content: 'Lacan volvería a insistir: no deseamos el objeto; deseamos el deseo que imaginamos que el objeto contiene. Queremos habitar la escena, pero no queremos asumir su dolor estructural.',
        author: 'Luis Virrueta'
      },
      {
        type: 'text',
        content: 'Queremos el brillo del drama, sin su herida real. Queremos el perfume del abismo sin caer dentro. La vida ajena siempre parece mejor porque no pesa.'
      },
      {
        type: 'list',
        title: '❓ Preguntas psicoanalíticas',
        items: [
          {
            title: '¿Cuántas de tus fantasías no sobrevivirían si las vivieras realmente?',
            description: 'El deseo pierde su brillo cuando se convierte en realidad cotidiana.'
          },
          {
            title: '¿Cuánto del deseo es espectáculo?',
            description: '¿Qué tanto de lo que crees querer es solo el placer de mirarlo desde lejos?'
          },
          {
            title: '¿Qué parte de tu vida te duele?',
            description: '¿Pero si la vieras desde fuera te parecería maravillosa?'
          }
        ]
      },
      {
        type: 'heading',
        title: 'CAPÍTULO III — El Otro como proyección y espejismo',
        icon: Sparkles
      },
      {
        type: 'text',
        content: 'También pasa con personas "inferiores" o "superiores". Un poderoso mira al mendigo y proyecta tragedia absoluta. Pero el mendigo no vive su vida como imagen trágica, vive el día, la comida, la supervivencia, la risa ocasional. Es el poderoso quien necesita verlo triste para sostener su narrativa.'
      },
      {
        type: 'highlight',
        content: 'Simone Weil decía: "Ver realmente es ya un acto de justicia." Y casi nunca vemos. Interpretamos. Narramos. Colonizamos la realidad del otro con nuestras categorías internas.',
        author: 'Simone Weil'
      },
      {
        type: 'text',
        content: 'Lacan hablaría del fantasma: la estructura imaginaria desde la que vemos el mundo. El mendigo no es mendigo: es pantalla donde el sujeto proyecta su miedo, su culpa, su deseo de sentirse noble.'
      },
      {
        type: 'highlight',
        content: 'Lo terrible es que nunca miramos al otro. Solo miramos nuestra herida reflejada.',
        author: 'Luis Virrueta'
      },
      {
        type: 'list',
        ...
        items: [
          {
            title: '¿Cuántas veces tu compasión es narcisismo disfrazado?',
            description: 'La piedad puede ser una forma de confirmar nuestra propia superioridad.'
          },
          {
            title: '¿Cuántas veces llamas "pobre" a quien simplemente no cabe en tu fantasía de éxito?',
            description: 'Proyectamos pobreza donde hay simplemente otra forma de vivir.'
          },
          {
            title: '¿Qué versión de ti protege la narrativa que construyes del otro?',
            description: 'Cada juicio sobre el otro es una defensa de nuestra propia identidad.'
          }
        ]
      },
      {
        type: 'heading',
        title: 'CAPÍTULO IV — El espejismo de las multitudes',
        icon: Users
      },
      {
        type: 'text',
        content: 'Me he visto fascinado por multitudes vibrando juntas: festivales, plazas, ciudades turísticas llenas de vida. Quisiera pertenecer. Quisiera disolverme en esa marea humana… pero cuando enfoco realmente, descubro que esa multitud no es una unidad viva. Son fragmentos. Grupos aislados. Vidas inconexas ocupando un mismo espacio.'
      },
      {
        type: 'highlight',
        content: 'La masa no es un organismo; es una colección de soledades. Byung-Chul Han lo explica magistralmente: la sociedad contemporánea es una suma de "egos inmunes", coexistiendo pero sin tocarse realmente.',
        author: 'Byung-Chul Han'
      },
      {
        type: 'text',
        content: 'La ilusión del colectivo aparece solo cuando no estamos dentro de él. Mi mente crea una música emocional que no existe. Yo pongo la poesía; la realidad pone cuerpos caminando.'
      },
      {
        type: 'highlight',
        content: 'Y entonces comprendo: No extraño pertenecer. Extraño una forma de comunión que probablemente no existe.',
        author: 'Luis Virrueta'
      },
      {
        type: 'list',
        ...
        items: [
          {
            title: '¿Qué multitudes idealizas porque temes tu propia soledad?',
            description: 'La fascinación por la masa puede ser huida del encuentro contigo mismo.'
          },
          {
            title: '¿Qué esperas encontrar en los otros que no soportas buscar dentro de ti?',
            description: 'A veces buscamos en la multitud lo que nos aterra encontrar en soledad.'
          },
          {
            title: '¿Es la multitud compañía… o anestesia?',
            description: '¿Buscas conexión real o solo distracción del vacío?'
          }
        ]
      },
      {
        type: 'heading',
        title: 'CAPÍTULO V — Cuando le quitamos narrativa al mundo',
        icon: Target
      },
      {
        type: 'text',
        content: 'Quizá si le quitamos la narrativa a las cosas, el mundo se vuelve extraño. Inquietante. Desconocido. Heidegger lo insinuó: lo habitual nos anestesia; solo cuando algo se rompe aparece la existencia desnuda.'
      },
      {
        type: 'text',
        content: 'Cuando dejamos de nombrar, el mundo deja de ser lo que creemos que es… y se convierte en algo que no sabemos sostener. Porque todo lo que "es", parece serlo solo en el choque entre quien mira y lo mirado. La realidad no es objetiva. Pero tampoco subjetiva. Es un campo de tensión.'
      },
      {
        type: 'highlight',
        content: 'Lacan lo resumiría así: "La realidad es organizada por el lenguaje, pero el núcleo del mundo permanece siempre imposible de simbolizar."',
        author: 'Jacques Lacan'
      },
      {
        type: 'text',
        content: 'Entonces… ¿qué estamos viendo cuando vemos? ¿El mundo? ¿O la máscara que nuestra psique coloca para no caer en el terror de lo Real?'
      },
      {
        type: 'list',
        title: '❓ Preguntas psicoanalíticas finales',
        items: [
          {
            title: 'Si quitaras toda narrativa, ¿quién serías sin relato?',
            description: '¿Existe un "yo" más allá de la historia que me cuento sobre mí mismo?'
          },
          {
            title: 'Si dejaras de contarte lo que crees que eres, ¿seguirías existiendo de la misma manera?',
            description: 'La identidad es un relato que nos contamos para no caer en el abismo.'
          },
          {
            title: '¿Cuánto del sufrimiento humano nace de confundir fantasía con mundo?',
            description: 'Y mundo con fantasía. Sufrimos porque no distinguimos entre lo real y lo imaginado.'
          }
        ]
      },
      {
        type: 'callToAction',
        title: '¿Listo para cuestionar tu mirada?',
        description: 'En mis sesiones de psicología Aion, trabajamos en desmontar las narrativas que construyes sobre ti, sobre los otros y sobre el mundo.',
        buttonText: 'Explorar método Aion',
        buttonLink: '/contacto'
      },
      {
        type: 'conclusion',
        content: 'Lo que miramos nunca es neutral. Cada mirada es una construcción, cada percepción una proyección. No vemos el mundo: vemos nuestra relación con él. Y en esa distancia entre lo que es y lo que creemos que es, habita toda la tragedia y toda la belleza de la existencia humana.'
      }
    ],
    comments: [
      {
        ...
        avatar: 'AM',
        date: '07 Ene 2026',
        content: 'Este ensayo me conmovió profundamente. La forma en que explicas la distancia entre mirar y vivir es exactamente lo que he sentido tantas veces sin poder nombrarlo. Gracias.',
        language: 'es'
      },
      {
        id: 2,
        ...
        avatar: 'RS',
        date: '07 Ene 2026',
        content: 'Las referencias a Lacan, Sartre y Heidegger están perfectamente integradas. No es solo teoría, es experiencia filosófica viva. Magistral.',
        language: 'es'
      }
    ],
    relatedArticles: [
