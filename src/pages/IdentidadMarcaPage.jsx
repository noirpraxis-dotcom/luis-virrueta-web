    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-zinc-950 to-black">
      ...
      <section ref={heroRef} className="relative py-20 lg:py-32 px-6 lg:px-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          >
            <Palette className="w-16 h-16 mx-auto text-purple-400 mb-6" strokeWidth={1.5} />
            ...
            <div className="h-px bg-gradient-to-r from-transparent via-purple-500/40 to-transparent w-80 mx-auto mt-8" />
          </motion.div>
        </div>
      </section>
      ...
      <div className="px-6 lg:px-20 pb-20">
        <div className="max-w-6xl mx-auto space-y-20">
          ...
          {/* ¿Qué es? */}
          <Section title="¿Qué es Identidad de Marca?" icon={Palette}>
          ...
          <Section title="¿Qué Incluye el Servicio?">
            <div className="grid md:grid-cols-2 gap-4">
              {[
                '[Item 1 - Ejemplo: Logo principal y variantes]',
                '[Item 2 - Ejemplo: Paleta de colores completa]',
                '[Item 3 - Ejemplo: Tipografía corporativa]',
                '[Item 4 - Ejemplo: Manual de marca]',
                '[Item 5 - Ejemplo: Papelería básica]',
                '[Item 6 - Ejemplo: Templates redes sociales]',
                '[Item 7 - Ejemplo: Iconografía]',
                '[Item 8 - Ejemplo: Aplicaciones mockups]'
              ].map((item, i) => (
                <motion.div
                  key={i}
                  ...
                  className="flex items-start gap-3 p-4 bg-white/5 border border-white/10 rounded-xl hover:border-purple-500/30 transition-all"
                >
            ...
            <div className="space-y-6">
              {[
                ...
                <motion.div
                  ...
                  className="flex gap-6 p-6 bg-white/5 border border-white/10 rounded-xl hover:border-purple-500/30 transition-all"
                >
                  <div className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent font-mono flex-shrink-0">
                    {item.step}
                  </div>
                  <div>
          ...
          <Section title="Inversión y Tiempos">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-purple-950/30 to-fuchsia-950/30 border border-purple-500/30 rounded-2xl p-8">
                <h4 className="text-sm uppercase tracking-wider text-purple-400 mb-2 font-mono">Inversión</h4>
              ...
              <div className="bg-gradient-to-br from-purple-950/30 to-fuchsia-950/30 border border-purple-500/30 rounded-2xl p-8">
                <h4 className="text-sm uppercase tracking-wider text-purple-400 mb-2 font-mono">Duración</h4>
                <p className="text-4xl font-bold text-white mb-4 font-display">
                  [X semanas]
                </p>
          ...
          <div className="text-center py-12">
            ...
            <Link
              to="/contacto"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-purple-500 to-fuchsia-500 text-white font-semibold rounded-full hover:shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105"
            >
              Empezar Proyecto
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-8">
        {Icon && <Icon className="w-8 h-8 text-purple-400" strokeWidth={1.5} />}
...
export default IdentidadMarcaPage
